...
const { jsonSchemaFromMetadata } = require('./model-json-schema')
...
function mixinModel(Model) {
  ...
  class KoaliModel extends Model {
    ...
    /**
     * parse json schema from table metadata
     *
     * @param {Object} jsonSchema need merged json schema
     *
     */
    static jsonSchemaFromMetadata(jsonSchema, opt) {
      let metadata = this.tableMetadata()
      return jsonSchemaFromMetadata(this, metadata, jsonSchema, opt)
    }
